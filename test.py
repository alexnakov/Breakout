...
ball = Ball(300, 150, 10, (1, -10), 10)

h1 = UpToDownHorizontalCollisionLine(200, 200, 50)
h2 = DownToUpHorizontalCollisionLine(200, 200, 250)
v1 = LeftToRightVerticalCollisionLine(200, 200, 50)
v2 = RightToLeftVerticalCollisionLine(200, 400, 50)
